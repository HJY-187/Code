...
class DENet(nn.Module):
    ...
    def __init__(self, seq_len: int, pred_len: int, features: int = 6,
        ...
        # Optional Blocks
        if self.use_auto:
            # AS1 block needs full features dim if passed, but here passed features=6
...
def main():
    ...
    if final_best_model is not None:
        ...
        print("save to: best_opt_model.pth")
...
[Model B (+AS2)] Learned Weights -> N-HiTS: -0.0006
[Model B (+AS2)] Done. RMSE: 4.8954, R2: 0.9848

Training Full Model (Optimized)...
[Full Model (Optimized)] Learned Weights -> Auto: 0.5516 N-HiTS: -0.0000
...
Model B (+AS2)    | 3.288767 | 4.895439 | 0.984779
...
Model B (+AS2)    | 2.234645 | 4.706626 | 6.501599
