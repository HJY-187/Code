...
class ImprovedRBreakerStrategy(bt.Strategy):
    ...
    def __init__(self):
        ...
        if not self.logger.handlers:
            fh = logging.FileHandler('../../WR/Strategy/ImprovedRBreaker.log', mode='w')
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--minute-data-path',
        default='WR_5.csv',
        help='Path to minute-level market data CSV, default WR_5.csv'
    )
    parser.add_argument(
        '--prev-daily-path',
    ...
    parser.add_argument('--f1', type=float, default=0.3, help='f1 parameter (default: 0.3)')
    parser.add_argument('--f2', type=float, default=0.1, help='f2 parameter (default: 0.1)')
    ...
    initial_capital = 3600  # Initial capital
...
"""
===== Backtest Results =====
Total return rate: 761.86%
Total number of trades: 153
Number of winning trades: 94
Win rate: 61.44%
Maximum drawdown: 62.63%
Annualized return rate: 208.37%
Sharpe ratio: 0.09
