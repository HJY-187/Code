# -*- coding: utf-8 -*-
"""
Optimized Version - PatchTST Model (Fixed Dimension Error Version)
(Target: Next Day Close | Optimizations: Calendar Features, Long-period Parameters, Trend Accuracy | Results saved to ../strategy/pred_daily_advanced.csv)
"""
