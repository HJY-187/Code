...
if __name__ == '__main__':
    ...
    parser.add_argument('--f2', type=float, default=0.4, help='f2 parameter (default: 0.4)')
    ...
    initial_capital = 60000  # Initial capital
