...
def preprocess_df(df: pd.DataFrame, val_col_name: str, model_tag: str) -> pd.DataFrame:
    ...
    dt_col = pick_first_existing(df, ["datetime", "date", "dt", "time", "日期", "时间"], required=False)
...
"""
     ...
     tsmixer        435                     0 4897.759804 5469.947003  572.187198  2.0418          2.058562e-02 2.058562e-02            True     5    base_better
     dlinear        435                     0 4897.759804 6561.244808 1663.485004  3.8574          5.729589e-05 7.639452e-05            True     5    base_better
    patchtst        435                     0 4897.759804 6931.745835 2033.986031  3.9891          3.316078e-05 6.632156e-05            True     5    base_better
itransformer        435                     0 4897.759804 9115.170610 4217.410805  4.3189          7.841202e-06 3.136481e-05            True     5    base_better
"""