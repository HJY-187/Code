...
class ImprovedRBreakerStrategy(bt.Strategy):
    ...
    def __init__(self):
        ...
        if not self.logger.handlers:
            fh = logging.FileHandler('../../JM/Strategy/ImprovedRBreaker.log', mode='w')
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--minute-data-path',
        default='JM_5.csv',
        help='Path to minute-level market data CSV, default JM_5.csv'
    )
    parser.add_argument(
        '--prev-daily-path',
    ...
    parser.add_argument('--f1', type=float, default=0.4, help='f1 parameter (default: 0.4)')
    ...
    initial_capital = 30000  # Initial capital
...
"""
===== Backtest Results =====
Total return rate: 68.75%
Total number of trades: 94
Number of winning trades: 64
Win rate: 68.09%
Maximum drawdown: 22.90%
Annualized return rate: 30.95%
Sharpe ratio: 0.10
"""
