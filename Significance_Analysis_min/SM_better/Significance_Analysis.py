...
"""
================================================================================
PATCHTST vs BASE: GW=10.8073, p=1.5890e-27, Lags=11 -> 显著
DLINEAR vs BASE: GW=6.0694, p=6.4197e-10, Lags=11 -> 显著
ITRANSFORMER vs BASE: GW=8.6474, p=2.6345e-18, Lags=11 -> 显著
TSMIXER vs BASE: GW=4.8945, p=4.9274e-07, Lags=11 -> 显著

================================================================================
--- Step 1 ---
  patchtst: p=2.6160e-68 (Lag=9)
  dlinear: p=1.4894e-40 (Lag=9)
  itransformer: p=7.3206e-67 (Lag=9)
  tsmixer: p=1.3459e-56 (Lag=9)
--- Step 2 ---
  patchtst: p=2.4792e-47 (Lag=9)
  dlinear: p=2.6142e-24 (Lag=9)
  itransformer: p=1.0109e-43 (Lag=9)
  tsmixer: p=7.2265e-37 (Lag=9)
--- Step 3 ---
  patchtst: p=1.1867e-33 (Lag=9)
  dlinear: p=6.9735e-17 (Lag=9)
  itransformer: p=2.9141e-34 (Lag=9)
  tsmixer: p=2.7399e-23 (Lag=9)
--- Step 4 ---
  patchtst: p=3.9895e-25 (Lag=9)
  dlinear: p=1.0273e-12 (Lag=9)
  itransformer: p=1.6999e-29 (Lag=9)
  tsmixer: p=6.3090e-11 (Lag=9)
--- Step 5 ---
  patchtst: p=4.6202e-21 (Lag=9)
  dlinear: p=4.7899e-09 (Lag=9)
  itransformer: p=1.7963e-18 (Lag=9)
  tsmixer: p=5.5821e-06 (Lag=9)
--- Step 6 ---
  patchtst: p=7.8909e-14 (Lag=9)
  dlinear: p=1.4686e-06 (Lag=9)
  itransformer: p=8.3712e-14 (Lag=9)
  tsmixer: p=3.3619e-03 (Lag=9)
--- Step 7 ---
  patchtst: p=6.6229e-13 (Lag=9)
  dlinear: p=9.9651e-09 (Lag=9)
  itransformer: p=1.3079e-11 (Lag=9)
  tsmixer: p=2.0285e-05 (Lag=9)
--- Step 8 ---
  patchtst: p=6.4291e-15 (Lag=9)
  dlinear: p=9.2236e-06 (Lag=9)
  itransformer: p=1.8435e-10 (Lag=9)
  tsmixer: p=5.6821e-05 (Lag=9)
--- Step 9 ---
  patchtst: p=5.0301e-14 (Lag=9)
  dlinear: p=8.2056e-04 (Lag=9)
  itransformer: p=4.4764e-09 (Lag=9)
  tsmixer: p=2.4765e-04 (Lag=9)
--- Step 10 ---
  patchtst: p=9.5418e-11 (Lag=9)
  dlinear: p=8.3441e-04 (Lag=9)
  itransformer: p=1.0994e-07 (Lag=9)
  tsmixer: p=9.7540e-02 (Lag=9)
--- Step 11 ---
  patchtst: p=2.6993e-09 (Lag=10)
  dlinear: p=3.2121e-02 (Lag=10)
  itransformer: p=1.6331e-06 (Lag=10)
  tsmixer: p=3.0210e-01 (Lag=10)
--- Step 12 ---
  patchtst: p=2.1027e-06 (Lag=11)
  dlinear: p=7.6827e-02 (Lag=11)
  itransformer: p=1.4216e-06 (Lag=11)
  tsmixer: p=5.3077e-01 (Lag=11)
