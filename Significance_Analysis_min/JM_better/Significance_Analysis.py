...
================================================================================
PATCHTST vs BASE: GW=12.3316, p=3.0594e-35, Lags=11 -> Significant
DLINEAR vs BASE: GW=11.3883, p=2.3923e-30, Lags=11 -> Significant
ITRANSFORMER vs BASE: GW=13.6087, p=1.7766e-42, Lags=11 -> Significant
TSMIXER vs BASE: GW=7.4481, p=4.7349e-14, Lags=11 -> Significant

================================================================================
[Stage 2] Stepwise tests (12 steps) + global FDR correction
================================================================================
--- Step 1 ---
  patchtst: p=1.8541e-92 (Lag=9)
  dlinear: p=1.4372e-92 (Lag=9)
  itransformer: p=3.2552e-108 (Lag=9)
  tsmixer: p=4.8571e-53 (Lag=9)
--- Step 2 ---
  patchtst: p=2.1975e-64 (Lag=9)
  dlinear: p=2.1297e-57 (Lag=9)
  itransformer: p=9.0907e-86 (Lag=9)
  tsmixer: p=9.2401e-29 (Lag=9)
--- Step 3 ---
  patchtst: p=6.2724e-36 (Lag=9)
  dlinear: p=2.0639e-41 (Lag=9)
  itransformer: p=7.5788e-68 (Lag=9)
  tsmixer: p=1.0272e-19 (Lag=9)
--- Step 4 ---
  patchtst: p=4.7119e-25 (Lag=9)
  dlinear: p=9.4173e-32 (Lag=9)
  itransformer: p=4.5792e-64 (Lag=9)
  tsmixer: p=2.6978e-21 (Lag=9)
--- Step 5 ---
  patchtst: p=1.3107e-28 (Lag=9)
  dlinear: p=4.9021e-38 (Lag=9)
  itransformer: p=2.4521e-48 (Lag=9)
  tsmixer: p=7.1559e-11 (Lag=9)
--- Step 6 ---
  patchtst: p=1.1483e-20 (Lag=9)
  dlinear: p=1.1764e-23 (Lag=9)
  itransformer: p=5.3046e-45 (Lag=9)
  tsmixer: p=8.4353e-10 (Lag=9)
--- Step 7 ---
  patchtst: p=1.1237e-20 (Lag=9)
  dlinear: p=1.6640e-23 (Lag=9)
  itransformer: p=1.5872e-39 (Lag=9)
  tsmixer: p=3.2967e-07 (Lag=9)
--- Step 8 ---
  patchtst: p=1.5239e-21 (Lag=9)
  dlinear: p=2.0779e-22 (Lag=9)
  itransformer: p=3.5610e-35 (Lag=9)
  tsmixer: p=1.6786e-06 (Lag=9)
--- Step 9 ---
  patchtst: p=3.3276e-18 (Lag=9)
  dlinear: p=1.4003e-18 (Lag=9)
  itransformer: p=5.5384e-33 (Lag=9)
  tsmixer: p=5.0385e-05 (Lag=9)
--- Step 10 ---
  patchtst: p=5.0073e-17 (Lag=9)
  dlinear: p=6.0509e-18 (Lag=9)
  itransformer: p=1.3558e-31 (Lag=9)
  tsmixer: p=2.5525e-05 (Lag=9)
--- Step 11 ---
  patchtst: p=7.3498e-09 (Lag=10)
  dlinear: p=6.5248e-11 (Lag=10)
  itransformer: p=1.1681e-28 (Lag=10)
  tsmixer: p=1.1870e-02 (Lag=10)
--- Step 12 ---
  patchtst: p=2.5107e-07 (Lag=11)
  dlinear: p=6.0423e-10 (Lag=11)
  itransformer: p=9.6004e-26 (Lag=11)
  tsmixer: p=3.4801e-02 (Lag=11)
"""
