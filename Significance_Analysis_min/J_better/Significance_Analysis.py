...
================================================================================
PATCHTST vs BASE: GW=13.5013, p=7.6838e-42, Lags=11 -> Significant
DLINEAR vs BASE: GW=9.3959, p=2.8359e-21, Lags=11 -> Significant
ITRANSFORMER vs BASE: GW=16.3932, p=1.0698e-60, Lags=11 -> Significant
TSMIXER vs BASE: GW=10.3278, p=2.6387e-25, Lags=11 -> Significant

================================================================================
[Stage 2] Stepwise tests (12 steps) + global FDR correction
================================================================================
--- Step 1 ---
  patchtst: p=6.0063e-124 (Lag=9)
  dlinear: p=4.0989e-68 (Lag=9)
  itransformer: p=2.4797e-143 (Lag=9)
  tsmixer: p=1.2667e-141 (Lag=9)
--- Step 2 ---
  patchtst: p=8.6467e-77 (Lag=9)
  dlinear: p=1.7916e-42 (Lag=9)
  itransformer: p=7.6288e-136 (Lag=9)
  tsmixer: p=5.1792e-44 (Lag=9)
--- Step 3 ---
  patchtst: p=6.8251e-54 (Lag=9)
  dlinear: p=1.2265e-29 (Lag=9)
  itransformer: p=5.6203e-98 (Lag=9)
  tsmixer: p=9.6754e-18 (Lag=9)
--- Step 4 ---
  patchtst: p=2.1926e-42 (Lag=9)
  dlinear: p=2.8954e-24 (Lag=9)
  itransformer: p=4.6887e-85 (Lag=9)
  tsmixer: p=2.0380e-12 (Lag=9)
--- Step 5 ---
  patchtst: p=6.4798e-34 (Lag=9)
  dlinear: p=9.5866e-20 (Lag=9)
  itransformer: p=6.2803e-69 (Lag=9)
  tsmixer: p=4.4190e-18 (Lag=9)
--- Step 6 ---
  patchtst: p=4.0665e-26 (Lag=9)
  dlinear: p=5.8442e-15 (Lag=9)
  itransformer: p=4.0281e-60 (Lag=9)
  tsmixer: p=1.0594e-12 (Lag=9)
--- Step 7 ---
  patchtst: p=1.6207e-22 (Lag=9)
  dlinear: p=2.4497e-12 (Lag=9)
  itransformer: p=1.0722e-48 (Lag=9)
  tsmixer: p=2.1705e-06 (Lag=9)
--- Step 8 ---
  patchtst: p=9.7957e-15 (Lag=9)
  dlinear: p=1.2414e-11 (Lag=9)
  itransformer: p=2.7791e-40 (Lag=9)
  tsmixer: p=2.9892e-04 (Lag=9)
--- Step 9 ---
  patchtst: p=6.0007e-09 (Lag=9)
  dlinear: p=1.7260e-05 (Lag=9)
  itransformer: p=2.3144e-34 (Lag=9)
  tsmixer: p=1.7188e-03 (Lag=9)
--- Step 10 ---
  patchtst: p=4.9668e-14 (Lag=9)
  dlinear: p=3.5073e-08 (Lag=9)
  itransformer: p=1.9661e-31 (Lag=9)
  tsmixer: p=8.8085e-07 (Lag=9)
--- Step 11 ---
  patchtst: p=2.7593e-13 (Lag=10)
  dlinear: p=1.6236e-14 (Lag=10)
  itransformer: p=6.1408e-25 (Lag=10)
  tsmixer: p=6.1167e-09 (Lag=10)
--- Step 12 ---
  patchtst: p=1.1449e-10 (Lag=11)
  dlinear: p=2.1079e-07 (Lag=11)
  itransformer: p=1.3701e-21 (Lag=11)
  tsmixer: p=4.2264e-10 (Lag=11)
"""
