...
"""
================================================================================
PATCHTST vs BASE: GW=6.9585, p=1.7200e-12, Lags=11 -> 显著
DLINEAR vs BASE: GW=5.6511, p=7.9691e-09, Lags=11 -> 显著
ITRANSFORMER vs BASE: GW=7.9698, p=7.9461e-16, Lags=11 -> 显著
TSMIXER vs BASE: GW=17.7965, p=3.7609e-71, Lags=11 -> 显著

================================================================================
--- Step 1 ---
  patchtst: p=5.4851e-33 (Lag=9)
  dlinear: p=3.9848e-29 (Lag=9)
  itransformer: p=2.6709e-31 (Lag=9)
  tsmixer: p=1.0110e-104 (Lag=9)
--- Step 2 ---
  patchtst: p=1.2725e-18 (Lag=9)
  dlinear: p=1.1943e-21 (Lag=9)
  itransformer: p=4.6961e-26 (Lag=9)
  tsmixer: p=1.5344e-73 (Lag=9)
--- Step 3 ---
  patchtst: p=4.0576e-09 (Lag=9)
  dlinear: p=1.3404e-05 (Lag=9)
  itransformer: p=8.6671e-22 (Lag=9)
  tsmixer: p=2.6534e-77 (Lag=9)
--- Step 4 ---
  patchtst: p=1.9469e-16 (Lag=9)
  dlinear: p=1.2161e-18 (Lag=9)
  itransformer: 失败 (序列非平稳 (p=0.0626))
  tsmixer: p=1.8040e-109 (Lag=9)
--- Step 5 ---
  patchtst: p=9.9447e-13 (Lag=9)
  dlinear: p=1.1154e-05 (Lag=9)
  itransformer: 失败 (序列非平稳 (p=0.0510))
  tsmixer: p=1.4341e-130 (Lag=9)
--- Step 6 ---
  patchtst: p=8.2696e-11 (Lag=9)
  dlinear: p=1.4254e-04 (Lag=9)
  itransformer: p=1.3132e-18 (Lag=9)
  tsmixer: p=8.3465e-60 (Lag=9)
--- Step 7 ---
  patchtst: p=9.0361e-10 (Lag=9)
  dlinear: p=1.1333e-05 (Lag=9)
  itransformer: p=3.3440e-16 (Lag=9)
  tsmixer: p=1.9263e-57 (Lag=9)
--- Step 8 ---
  patchtst: p=3.8523e-07 (Lag=9)
  dlinear: p=9.2098e-08 (Lag=9)
  itransformer: p=6.0658e-16 (Lag=9)
  tsmixer: p=2.9607e-55 (Lag=9)
--- Step 9 ---
  patchtst: p=7.9962e-08 (Lag=9)
  dlinear: p=8.6963e-03 (Lag=9)
  itransformer: p=3.8565e-14 (Lag=9)
  tsmixer: p=1.3873e-36 (Lag=9)
--- Step 10 ---
  patchtst: p=1.1121e-06 (Lag=9)
  dlinear: p=4.4426e-04 (Lag=9)
  itransformer: p=7.4107e-13 (Lag=9)
  tsmixer: p=1.1479e-44 (Lag=9)
--- Step 11 ---
  patchtst: p=2.4359e-05 (Lag=10)
  dlinear: p=2.1091e-04 (Lag=10)
  itransformer: p=1.5495e-11 (Lag=10)
  tsmixer: p=2.4401e-37 (Lag=10)
--- Step 12 ---
  patchtst: p=6.9335e-07 (Lag=11)
  dlinear: p=3.8660e-02 (Lag=11)
  itransformer: p=7.0334e-10 (Lag=11)
  tsmixer: p=5.8927e-26 (Lag=11)
