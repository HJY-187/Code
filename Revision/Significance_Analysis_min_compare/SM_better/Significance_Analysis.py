...
================================================================================
PATCHTST vs BASE: GW=10.4957, p=4.5187e-26, Lags=11 -> Significant
DLINEAR vs BASE: GW=7.1171, p=5.5104e-13, Lags=11 -> Significant
ITRANSFORMER vs BASE: GW=6.8120, p=4.8126e-12, Lags=11 -> Significant
TSMIXER vs BASE: GW=10.1742, p=1.2927e-24, Lags=11 -> Significant

================================================================================
[Stage 2] Stepwise tests (12 steps) + global FDR correction
================================================================================
--- Step 1 ---
  patchtst: p=1.4948e-67 (Lag=9)
  dlinear: p=2.7947e-42 (Lag=9)
  itransformer: p=2.0736e-46 (Lag=9)
  tsmixer: p=5.7553e-81 (Lag=9)
--- Step 2 ---
  patchtst: p=3.2883e-44 (Lag=9)
  dlinear: p=5.0221e-29 (Lag=9)
  itransformer: p=3.2388e-32 (Lag=9)
  tsmixer: p=1.2239e-58 (Lag=9)
--- Step 3 ---
  patchtst: p=2.1249e-28 (Lag=9)
  dlinear: p=6.1759e-22 (Lag=9)
  itransformer: p=2.4127e-22 (Lag=9)
  tsmixer: p=1.8990e-38 (Lag=9)
--- Step 4 ---
  patchtst: p=8.1411e-22 (Lag=9)
  dlinear: p=3.2607e-14 (Lag=9)
  itransformer: p=7.2315e-18 (Lag=9)
  tsmixer: p=4.6045e-30 (Lag=9)
--- Step 5 ---
  patchtst: p=3.0107e-19 (Lag=9)
  dlinear: p=1.1999e-10 (Lag=9)
  itransformer: p=5.4116e-13 (Lag=9)
  tsmixer: p=4.6747e-26 (Lag=9)
--- Step 6 ---
  patchtst: p=5.0322e-13 (Lag=9)
  dlinear: p=5.6362e-07 (Lag=9)
  itransformer: p=1.3969e-09 (Lag=9)
  tsmixer: p=6.3357e-10 (Lag=9)
--- Step 7 ---
  patchtst: p=2.4374e-11 (Lag=9)
  dlinear: p=6.8997e-06 (Lag=9)
  itransformer: p=5.0174e-08 (Lag=9)
  tsmixer: p=8.3614e-07 (Lag=9)
--- Step 8 ---
  patchtst: p=2.7337e-14 (Lag=9)
  dlinear: p=1.7857e-05 (Lag=9)
  itransformer: p=5.4588e-07 (Lag=9)
  tsmixer: p=1.4563e-06 (Lag=9)
--- Step 9 ---
  patchtst: p=9.4385e-14 (Lag=9)
  dlinear: p=6.5595e-05 (Lag=9)
  itransformer: p=5.5721e-06 (Lag=9)
  tsmixer: p=9.9963e-06 (Lag=9)
--- Step 10 ---
  patchtst: p=1.5876e-10 (Lag=9)
  dlinear: p=9.1092e-05 (Lag=9)
  itransformer: p=8.1836e-05 (Lag=9)
  tsmixer: p=4.1800e-05 (Lag=9)
--- Step 11 ---
  patchtst: p=4.4932e-09 (Lag=10)
  dlinear: p=1.5927e-05 (Lag=10)
  itransformer: p=7.3110e-04 (Lag=10)
  tsmixer: p=3.1885e-06 (Lag=10)
--- Step 12 ---
  patchtst: p=3.2058e-06 (Lag=11)
  dlinear: p=4.2522e-08 (Lag=11)
  itransformer: p=8.6714e-03 (Lag=11)
  tsmixer: p=4.1486e-09 (Lag=11)
