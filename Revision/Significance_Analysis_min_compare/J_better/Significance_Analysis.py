...
================================================================================
PATCHTST vs BASE: GW=13.9097, p=2.7668e-44, Lags=11 -> Significant
DLINEAR vs BASE: GW=11.7192, p=5.0802e-32, Lags=11 -> Significant
ITRANSFORMER vs BASE: GW=12.1439, p=3.0900e-34, Lags=11 -> Significant
TSMIXER vs BASE: GW=8.2826, p=6.0262e-17, Lags=11 -> Significant

================================================================================
[Stage 2] Stepwise tests (12 steps) + global FDR correction
================================================================================
--- Step 1 ---
  patchtst: p=7.0231e-126 (Lag=9)
  dlinear: p=5.0227e-99 (Lag=9)
  itransformer: p=4.6174e-129 (Lag=9)
  tsmixer: p=9.0706e-68 (Lag=9)
--- Step 2 ---
  patchtst: p=1.1126e-82 (Lag=9)
  dlinear: p=1.6007e-72 (Lag=9)
  itransformer: p=2.7650e-86 (Lag=9)
  tsmixer: p=5.6601e-43 (Lag=9)
--- Step 3 ---
  patchtst: p=1.3125e-59 (Lag=9)
  dlinear: p=1.1301e-49 (Lag=9)
  itransformer: p=1.1407e-50 (Lag=9)
  tsmixer: p=5.5744e-22 (Lag=9)
--- Step 4 ---
  patchtst: p=1.6721e-46 (Lag=9)
  dlinear: p=2.4369e-42 (Lag=9)
  itransformer: p=4.2131e-38 (Lag=9)
  tsmixer: p=1.3126e-18 (Lag=9)
--- Step 5 ---
  patchtst: p=1.1021e-38 (Lag=9)
  dlinear: p=6.1602e-33 (Lag=9)
  itransformer: p=1.1590e-25 (Lag=9)
  tsmixer: p=3.0257e-13 (Lag=9)
--- Step 6 ---
  patchtst: p=3.3053e-31 (Lag=9)
  dlinear: p=3.0177e-29 (Lag=9)
  itransformer: p=3.3052e-22 (Lag=9)
  tsmixer: p=4.8353e-14 (Lag=9)
--- Step 7 ---
  patchtst: p=7.8279e-27 (Lag=9)
  dlinear: p=1.2953e-24 (Lag=9)
  itransformer: p=6.5658e-17 (Lag=9)
  tsmixer: p=2.4561e-13 (Lag=9)
--- Step 8 ---
  patchtst: p=1.5627e-18 (Lag=9)
  dlinear: p=1.4725e-20 (Lag=9)
  itransformer: p=9.1188e-16 (Lag=9)
  tsmixer: p=4.3201e-11 (Lag=9)
--- Step 9 ---
  patchtst: p=5.1523e-12 (Lag=9)
  dlinear: p=2.8815e-17 (Lag=9)
  itransformer: p=2.3240e-10 (Lag=9)
  tsmixer: p=3.1493e-08 (Lag=9)
--- Step 10 ---
  patchtst: p=4.7032e-17 (Lag=9)
  dlinear: p=8.2517e-18 (Lag=9)
  itransformer: p=2.5896e-13 (Lag=9)
  tsmixer: p=5.7636e-10 (Lag=9)
--- Step 11 ---
  patchtst: p=5.6855e-16 (Lag=10)
  dlinear: p=4.0038e-16 (Lag=10)
  itransformer: p=1.5834e-12 (Lag=10)
  tsmixer: p=2.8090e-04 (Lag=10)
--- Step 12 ---
  patchtst: p=5.5310e-12 (Lag=11)
  dlinear: p=9.2100e-14 (Lag=11)
  itransformer: p=3.9143e-11 (Lag=11)
  tsmixer: p=3.8726e-03 (Lag=11)
