...
================================================================================
PATCHTST vs BASE: GW=6.8959, p=2.6771e-12, Lags=11 -> Significant
DLINEAR vs BASE: GW=7.5143, p=2.8619e-14, Lags=11 -> Significant
ITRANSFORMER vs BASE: GW=8.3665, p=2.9690e-17, Lags=11 -> Significant
TSMIXER vs BASE: GW=11.9644, p=2.7291e-33, Lags=11 -> Significant

================================================================================
[Stage 2] Stepwise tests (12 steps) + global FDR correction
================================================================================
--- Step 1 ---
  patchtst: p=2.5839e-25 (Lag=9)
  dlinear: p=3.0229e-26 (Lag=9)
  itransformer: p=3.5773e-36 (Lag=9)
  tsmixer: p=7.4122e-84 (Lag=9)
--- Step 2 ---
  patchtst: p=7.2787e-19 (Lag=9)
  dlinear: p=5.2289e-17 (Lag=9)
  itransformer: p=2.2429e-30 (Lag=9)
  tsmixer: p=6.1019e-60 (Lag=9)
--- Step 3 ---
  patchtst: p=3.1900e-13 (Lag=9)
  dlinear: p=4.4690e-13 (Lag=9)
  itransformer: p=2.8896e-19 (Lag=9)
  tsmixer: p=6.3340e-37 (Lag=9)
--- Step 4 ---
  patchtst: p=2.8933e-16 (Lag=9)
  dlinear: p=1.1894e-14 (Lag=9)
  itransformer: p=5.3646e-22 (Lag=9)
  tsmixer: p=1.9683e-30 (Lag=9)
--- Step 5 ---
  patchtst: p=7.0824e-13 (Lag=9)
  dlinear: p=1.0773e-14 (Lag=9)
  itransformer: p=1.1551e-17 (Lag=9)
  tsmixer: p=2.9429e-26 (Lag=9)
--- Step 6 ---
  patchtst: p=3.0031e-11 (Lag=9)
  dlinear: p=2.9100e-11 (Lag=9)
  itransformer: p=4.9647e-14 (Lag=9)
  tsmixer: p=9.9975e-24 (Lag=9)
--- Step 7 ---
  patchtst: p=2.6280e-10 (Lag=9)
  dlinear: p=7.6402e-18 (Lag=9)
  itransformer: p=1.2084e-12 (Lag=9)
  tsmixer: p=1.4434e-23 (Lag=9)
--- Step 8 ---
  patchtst: p=3.4470e-08 (Lag=9)
  dlinear: p=7.1739e-08 (Lag=9)
  itransformer: p=3.9759e-12 (Lag=9)
  tsmixer: p=2.0247e-26 (Lag=9)
--- Step 9 ---
  patchtst: p=2.2766e-08 (Lag=9)
  dlinear: p=2.9404e-11 (Lag=9)
  itransformer: p=1.4961e-10 (Lag=9)
  tsmixer: p=4.7759e-24 (Lag=9)
--- Step 10 ---
  patchtst: p=9.9992e-08 (Lag=9)
  dlinear: p=6.0875e-14 (Lag=9)
  itransformer: p=1.2617e-12 (Lag=9)
  tsmixer: p=4.5999e-20 (Lag=9)
--- Step 11 ---
  patchtst: p=6.2918e-07 (Lag=10)
  dlinear: p=5.5425e-13 (Lag=10)
  itransformer: p=1.7145e-09 (Lag=10)
  tsmixer: p=1.3189e-25 (Lag=10)
--- Step 12 ---
  patchtst: p=2.1869e-07 (Lag=11)
  dlinear: p=3.3953e-10 (Lag=11)
  itransformer: p=1.1339e-10 (Lag=11)
  tsmixer: p=6.2352e-21 (Lag=11)
