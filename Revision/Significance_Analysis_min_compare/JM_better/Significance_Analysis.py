...
================================================================================
PATCHTST vs BASE: GW=15.4939, p=1.9077e-54, Lags=11 -> Significant
DLINEAR vs BASE: GW=9.9320, p=1.5111e-23, Lags=11 -> Significant
ITRANSFORMER vs BASE: GW=11.7646, p=2.9710e-32, Lags=11 -> Significant
TSMIXER vs BASE: GW=2.1548, p=1.5590e-02, Lags=11 -> Significant

================================================================================
[Stage 2] Stepwise tests (12 steps) + global FDR correction
================================================================================
--- Step 1 ---
  patchtst: p=1.4834e-111 (Lag=9)
  dlinear: p=4.3843e-61 (Lag=9)
  itransformer: p=2.4133e-102 (Lag=9)
  tsmixer: p=6.0344e-02 (Lag=9)
--- Step 2 ---
  patchtst: p=1.7677e-80 (Lag=9)
  dlinear: p=1.9344e-44 (Lag=9)
  itransformer: p=2.5683e-68 (Lag=9)
  tsmixer: p=1.6071e-02 (Lag=9)
--- Step 3 ---
  patchtst: p=2.1813e-62 (Lag=9)
  dlinear: p=1.7363e-33 (Lag=9)
  itransformer: p=3.2329e-47 (Lag=9)
  tsmixer: p=5.0674e-04 (Lag=9)
--- Step 4 ---
  patchtst: p=9.6721e-53 (Lag=9)
  dlinear: p=3.8246e-28 (Lag=9)
  itransformer: p=2.8684e-34 (Lag=9)
  tsmixer: p=5.1216e-06 (Lag=9)
--- Step 5 ---
  patchtst: p=1.7803e-48 (Lag=9)
  dlinear: p=2.1232e-24 (Lag=9)
  itransformer: p=1.7171e-33 (Lag=9)
  tsmixer: p=4.2016e-03 (Lag=9)
--- Step 6 ---
  patchtst: p=2.1647e-43 (Lag=9)
  dlinear: p=1.7145e-19 (Lag=9)
  itransformer: p=4.6428e-24 (Lag=9)
  tsmixer: p=1.2140e-02 (Lag=9)
--- Step 7 ---
  patchtst: p=8.8687e-36 (Lag=9)
  dlinear: p=2.4227e-16 (Lag=9)
  itransformer: p=1.0917e-25 (Lag=9)
  tsmixer: p=2.2556e-02 (Lag=9)
--- Step 8 ---
  patchtst: p=6.6279e-32 (Lag=9)
  dlinear: p=9.6726e-15 (Lag=9)
  itransformer: p=3.7727e-23 (Lag=9)
  tsmixer: p=1.3715e-02 (Lag=9)
--- Step 9 ---
  patchtst: p=2.7297e-28 (Lag=9)
  dlinear: p=2.3273e-13 (Lag=9)
  itransformer: p=1.1097e-20 (Lag=9)
  tsmixer: p=9.1105e-02 (Lag=9)
--- Step 10 ---
  patchtst: p=2.0582e-25 (Lag=9)
  dlinear: p=4.4179e-12 (Lag=9)
  itransformer: p=9.4213e-20 (Lag=9)
  tsmixer: p=7.0233e-02 (Lag=9)
--- Step 11 ---
  patchtst: p=3.4153e-23 (Lag=10)
  dlinear: p=6.3174e-10 (Lag=10)
  itransformer: p=1.2141e-10 (Lag=10)
  tsmixer: p=4.8850e-01 (Lag=10)
--- Step 12 ---
  patchtst: p=9.7659e-21 (Lag=11)
  dlinear: p=9.0757e-09 (Lag=11)
  itransformer: p=2.6991e-09 (Lag=11)
  tsmixer: p=7.3066e-01 (Lag=11)
