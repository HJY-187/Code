...
================================================================================
PATCHTST vs BASE: GW=15.6798, p=1.0397e-55, Lags=11 -> Significant
DLINEAR vs BASE: GW=13.5325, p=5.0277e-42, Lags=11 -> Significant
ITRANSFORMER vs BASE: GW=16.0662, p=2.2024e-58, Lags=11 -> Significant
TSMIXER vs BASE: GW=10.4182, p=1.0236e-25, Lags=11 -> Significant

================================================================================
[Stage 2] Stepwise tests (12 steps) + global FDR correction
================================================================================
--- Step 1 ---
  patchtst: p=9.5769e-141 (Lag=9)
  dlinear: p=1.6943e-112 (Lag=9)
  itransformer: p=1.0735e-211 (Lag=9)
  tsmixer: p=2.3240e-96 (Lag=9)
--- Step 2 ---
  patchtst: p=9.9640e-97 (Lag=9)
  dlinear: p=5.6720e-74 (Lag=9)
  itransformer: p=1.5176e-136 (Lag=9)
  tsmixer: p=1.8289e-66 (Lag=9)
--- Step 3 ---
  patchtst: p=1.0429e-68 (Lag=9)
  dlinear: p=1.7951e-64 (Lag=9)
  itransformer: p=3.8648e-84 (Lag=9)
  tsmixer: p=8.3692e-47 (Lag=9)
--- Step 4 ---
  patchtst: p=1.1447e-51 (Lag=9)
  dlinear: p=1.2362e-53 (Lag=9)
  itransformer: p=1.0756e-69 (Lag=9)
  tsmixer: p=6.6116e-31 (Lag=9)
--- Step 5 ---
  patchtst: p=2.5172e-47 (Lag=9)
  dlinear: p=1.6692e-42 (Lag=9)
  itransformer: p=1.7997e-58 (Lag=9)
  tsmixer: p=9.6597e-26 (Lag=9)
--- Step 6 ---
  patchtst: p=8.4037e-43 (Lag=9)
  dlinear: p=8.4546e-39 (Lag=9)
  itransformer: p=1.6726e-49 (Lag=9)
  tsmixer: p=1.2653e-21 (Lag=9)
--- Step 7 ---
  patchtst: p=2.5885e-38 (Lag=9)
  dlinear: p=2.9902e-34 (Lag=9)
  itransformer: p=8.3520e-49 (Lag=9)
  tsmixer: p=3.8603e-19 (Lag=9)
--- Step 8 ---
  patchtst: p=2.2284e-33 (Lag=9)
  dlinear: p=4.9988e-29 (Lag=9)
  itransformer: p=1.8534e-37 (Lag=9)
  tsmixer: p=1.6276e-13 (Lag=9)
--- Step 9 ---
  patchtst: p=5.2937e-27 (Lag=9)
  dlinear: p=3.5923e-26 (Lag=9)
  itransformer: p=2.9427e-33 (Lag=9)
  tsmixer: p=9.1513e-12 (Lag=9)
--- Step 10 ---
  patchtst: p=1.3428e-21 (Lag=9)
  dlinear: p=2.8529e-21 (Lag=9)
  itransformer: p=3.0486e-25 (Lag=9)
  tsmixer: p=1.2501e-10 (Lag=9)
--- Step 11 ---
  patchtst: p=4.9902e-19 (Lag=10)
  dlinear: p=6.8376e-20 (Lag=10)
  itransformer: p=4.2048e-19 (Lag=10)
  tsmixer: p=3.7740e-10 (Lag=10)
--- Step 12 ---
  patchtst: p=1.7921e-17 (Lag=11)
  dlinear: p=2.3707e-16 (Lag=11)
  itransformer: p=1.0697e-16 (Lag=11)
  tsmixer: p=1.0562e-09 (Lag=11)

Performing global FDR correction...

================================================================================
All tests completed. Results saved to: GW_test_results_fixed_version.csv
Guide to reading conclusions:
1. [12-step average] Please refer to the 'Raw Significant' column, as it is a separate hypothesis.
2. [Step 1-12] Please prioritize the 'FDR Significant' column, which controls false positive risk.
================================================================================
"""