...
data = {
    ...
    'MAE': [36.3521, 34.7847, 34.9545, 34.4554],
    'RMSE': [46.9734, 45.5469, 45.9807, 45.5331],
    'R2': [0.9647, 0.9668, 0.9662, 0.9668]
}
"""
data = {
    'Model': ['Main Path', 'Main Path+Aux 1', 'Main Path+Aux 2', 'DENet'],
...
3       DENet 34.4554 45.5331 0.9668       54.1761
============================================================
"""
...
cbar.set_label('Relative Improvement(%)', fontsize=11, weight='bold')
cbar.outline.set_linewidth(0)  # Remove colorbar border

# Title (已修改为你要求的内容)
ax.set_title(
    'Daily-level Ablation Study on Coke Futures.',
    fontsize=16,
    weight='bold',
    pad=20
)
...
output_file = 'bubble_heatmap_sci_J.png'
pdf_file = 'bubble_heatmap_sci_J.pdf'
