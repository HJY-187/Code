...
CONFIG = {
    "file_paths": {
        "true": os.path.join(base_dir, "I_true.csv"),
        "DENet": os.path.join(base_dir, "pred_daily_advance.csv"),
...
Test Result Summary (one-sided H1: base better, FDR-BH corrected)
   model  n_samples  alignment_shift_days  base_loss  comp_loss diff_mean GW_stat p_one(H1:base_better)        p_fdr  is_significant  lags direction_by_t
     AS2        443                     0 281.990226 294.024528 12.034303  1.7048          4.411779e-02 4.411779e-02            True     5    base_better
     AS1        443                     0 281.990226 313.513866 31.523640  3.1858          7.216616e-04 1.082492e-03            True     5    base_better
baseline        443                     0 281.990226 343.602855 61.612629  4.1874          1.411000e-05 4.233001e-05            True     5    base_better
