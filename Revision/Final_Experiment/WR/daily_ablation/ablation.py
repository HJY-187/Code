...
class AblationModel(nn.Module):
    ...
    def forward(self, x):
        ...
        if (not self.use_auto) and (not self.use_nhits):
            out = 0.6 * base_pred
        elif self.use_auto and (not self.use_nhits):
            out = 0.8 * base_pred
        else:
...
0        Base 47.2558 72.6354 0.9579       46.2069
1  Base + AS1 46.1797 71.3519 0.9593       46.4368
2  Base + AS2 47.0474 70.6858 0.9601       48.0460
3       DENet 44.8028 69.0521 0.9619       49.4253
============================================================
"""