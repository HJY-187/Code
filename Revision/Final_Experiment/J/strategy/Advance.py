        ...
        for future in as_completed(future_to_params):
            ...
            if annual_ret > best_annual_return:
                ...
                print(
                    ...
                    f"Win: {win:.2f}% | DD: {dd:.2f}% | Trades: {trades} "
...
if __name__ == "__main__":
    ...
    parser.add_argument("--minute-data-path", default="J_5.csv")
...
Fixed Parameters from Training: f1=0.80, f2=0.30, f3=0.10
=======================================================
...
[Original R-Breaker]
Annualized return rate: 9.18%
Total return rate: 5.70%
Sharpe ratio: 1.01
Calmar ratio: 1.83
Win rate: 52.94%
...
[Prediction-Enhanced R-Breaker]
Annualized return rate: 10.88%
Total return rate: 6.73%
Sharpe ratio: 1.15
Calmar ratio: 2.17
Win rate: 52.94%
