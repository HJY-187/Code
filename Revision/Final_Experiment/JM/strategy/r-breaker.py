...
if __name__ == '__main__':
    ...
    parser.add_argument('--f1', type=float, default=0.5, help='f1 parameter (default: 0.8)')
    parser.add_argument('--f2', type=float, default=0.3, help='f2 parameter (default: 0.3)')
    parser.add_argument('--f3', type=float, default=0.1, help='f3 parameter (default: 0.2)')
