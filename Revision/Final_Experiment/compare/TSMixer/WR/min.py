...
LR = 1e-4  # TSMixer-specific learning rate
...
def train_model(model, train_loader, val_loader, epochs=160, lr=1e-4, model_dir='models_tsmixer'):
    ...
    sch = ReduceLROnPlateau(opt, mode='min', factor=0.5, patience=12, verbose=False)
    ...
    patience = 0
    early_stop_patience = 30  # Retain original TSMixer early stopping patience value
...
def main(data_file="WR_5.csv", output_dir="results_tsmixer", model_dir="models_tsmixer",
...
================================================================================
Step 01 - MSE: 467.165527, MAE: 15.135880, RMSE: 21.614012, R2: 0.997582
Step 02 - MSE: 576.926575, MAE: 16.155842, RMSE: 24.019296, R2: 0.997014
Step 03 - MSE: 642.813904, MAE: 16.312244, RMSE: 25.353775, R2: 0.996673
Step 04 - MSE: 725.312439, MAE: 16.801044, RMSE: 26.931625, R2: 0.996247
Step 05 - MSE: 835.135376, MAE: 18.000685, RMSE: 28.898709, R2: 0.995678
Step 06 - MSE: 944.700134, MAE: 19.159412, RMSE: 30.735975, R2: 0.995111
Step 07 - MSE: 1066.742188, MAE: 20.556774, RMSE: 32.661019, R2: 0.994480
Step 08 - MSE: 1189.797241, MAE: 22.049076, RMSE: 34.493438, R2: 0.993843
Step 09 - MSE: 1291.615601, MAE: 22.959410, RMSE: 35.939054, R2: 0.993316
Step 10 - MSE: 1381.263916, MAE: 23.653250, RMSE: 37.165359, R2: 0.992853
Step 11 - MSE: 1546.611206, MAE: 25.595776, RMSE: 39.326978, R2: 0.991997
Step 12 - MSE: 1643.198730, MAE: 26.390162, RMSE: 40.536388, R2: 0.991498

================================================================================
Overall Prediction Evaluation Metrics (All Steps Combined)
================================================================================
TSMixer Model - MSE: 1025.938354, MAE: 20.230728, RMSE: 32.030272, R2: 0.994691
