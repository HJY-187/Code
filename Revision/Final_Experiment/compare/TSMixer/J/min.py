...
LR = 1e-3  # TSMixer-specific learning rate (should not be too large)
DROPOUT = 0.4  # High Dropout for MLP to prevent overfitting, original parameters retained
...
def train_model(model, train_loader, val_loader, epochs=160, lr=5e-3, model_dir='models_tsmixer'):
    ...
    sch = ReduceLROnPlateau(opt, mode='min', factor=0.5, patience=6, verbose=False)
...
def main(data_file="J_5.csv", output_dir="results_tsmixer", model_dir="models_tsmixer",
...
=================================================================================
Evaluation Metrics for Each Prediction Step (Step 1 ~ Step 12)
================================================================================
Step 01 - MSE: 50.626656, MAE: 5.230292, RMSE: 7.115241, R2: 0.999020
Step 02 - MSE: 77.059502, MAE: 6.372382, RMSE: 8.778354, R2: 0.998508
Step 03 - MSE: 104.555077, MAE: 7.375935, RMSE: 10.225218, R2: 0.997976
Step 04 - MSE: 132.462784, MAE: 8.313457, RMSE: 11.509248, R2: 0.997436
Step 05 - MSE: 159.584641, MAE: 9.135517, RMSE: 12.632681, R2: 0.996912
Step 06 - MSE: 187.875031, MAE: 9.929459, RMSE: 13.706751, R2: 0.996364
Step 07 - MSE: 216.216354, MAE: 10.644497, RMSE: 14.704297, R2: 0.995816
Step 08 - MSE: 243.884613, MAE: 11.316086, RMSE: 15.616805, R2: 0.995282
Step 09 - MSE: 271.872864, MAE: 11.961331, RMSE: 16.488568, R2: 0.994741
Step 10 - MSE: 303.050232, MAE: 12.678155, RMSE: 17.408338, R2: 0.994138
Step 11 - MSE: 327.567291, MAE: 13.144358, RMSE: 18.098820, R2: 0.993665
Step 12 - MSE: 353.641663, MAE: 13.678421, RMSE: 18.805363, R2: 0.993161

================================================================================
Overall Prediction Evaluation Metrics (All Steps Combined)
================================================================================
TSMixer Model - MSE: 202.365646, MAE: 9.981660, RMSE: 14.225528, R2: 0.996085
"""