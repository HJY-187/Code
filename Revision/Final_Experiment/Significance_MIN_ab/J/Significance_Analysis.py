...
CONFIG = {
    "file_paths": {
        "baseline": os.path.join(base_dir, r"pred_minute_baseline.csv"),
        "base": os.path.join(base_dir, r"pred_minute_advanced.csv"),
        "model_A": os.path.join(base_dir, r"pred_minute_model_A.csv"),
        "model_B": os.path.join(base_dir, r"pred_minute_model_B.csv"),
        "true": os.path.join(base_dir, r"J_true.csv")
    },
    "models": ["base", "baseline", "model_A", "model_B"],
...
"""
PS D:\桌面\trea_Run> & D:/python/python.exe d:/桌面/trea_Run/J_min_Si/Significance_Analysis.py
Reading data...
Sample alignment completed, effective sample size: 27198

================================================================================
[Stage 1] 12-step average loss test (MAE)
================================================================================
BASELINE vs BASE: GW=26.5521, p=1.2147e-155, Lags=13 -> Significant
MODEL_A vs BASE: GW=15.0067, p=3.3174e-51, Lags=13 -> Significant
MODEL_B vs BASE: GW=21.0147, p=2.4040e-98, Lags=13 -> Significant

================================================================================
[Stage 2] Stepwise tests (12 steps) + global FDR correction
================================================================================
--- Step 1 ---
  baseline: p=0.0000e+00 (Lag=13)
  model_A: p=1.1985e-191 (Lag=13)
  model_B: p=0.0000e+00 (Lag=13)
--- Step 2 ---
  baseline: p=0.0000e+00 (Lag=13)
  model_A: p=4.0348e-120 (Lag=13)
  model_B: p=0.0000e+00 (Lag=13)
--- Step 3 ---
  baseline: p=1.7671e-215 (Lag=13)
  model_A: p=5.0815e-90 (Lag=13)
  model_B: p=3.7757e-261 (Lag=13)
--- Step 4 ---
  baseline: p=7.0838e-160 (Lag=13)
  model_A: p=6.2341e-54 (Lag=13)
  model_B: p=4.6289e-110 (Lag=13)
--- Step 5 ---
  baseline: p=1.4732e-109 (Lag=13)
  model_A: p=8.0197e-39 (Lag=13)
  model_B: p=7.1013e-70 (Lag=13)
--- Step 6 ---
  baseline: p=6.4998e-86 (Lag=13)
  model_A: p=1.3896e-20 (Lag=13)
  model_B: p=7.6766e-45 (Lag=13)
--- Step 7 ---
  baseline: p=2.2938e-64 (Lag=13)
  model_A: p=8.4919e-16 (Lag=13)
  model_B: p=1.1833e-40 (Lag=13)
--- Step 8 ---
  baseline: p=2.5927e-69 (Lag=13)
  model_A: p=5.2812e-12 (Lag=13)
  model_B: p=7.1463e-43 (Lag=13)
--- Step 9 ---
  baseline: p=1.3490e-50 (Lag=13)
  model_A: p=2.0854e-07 (Lag=13)
  model_B: p=3.4272e-37 (Lag=13)
--- Step 10 ---
  baseline: p=8.5028e-59 (Lag=13)
  model_A: p=1.0065e-11 (Lag=13)
  model_B: p=3.2060e-44 (Lag=13)
--- Step 11 ---
  baseline: p=2.0247e-50 (Lag=13)
  model_A: p=1.3750e-07 (Lag=13)
  model_B: p=4.1792e-27 (Lag=13)
--- Step 12 ---
  baseline: p=3.1023e-51 (Lag=13)
  model_A: p=1.9819e-07 (Lag=13)
  model_B: p=6.1210e-34 (Lag=13)
