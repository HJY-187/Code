...
def parse_metrics(output):
    ...
    calmar_ratio = float(calmar_match.group(1)) if calmar_match else -999.0
...
def optimize_on_prediction_period(
        ...
        for future in as_completed(future_to_params):
            ...
            if annual_ret > best_annual_return:
                ...
                print(
                    ...
                    f"Win: {win:.2f}% | DD: {dd:.2f}% | Trades: {trades} "  # 新增 Trades
    ...
    if best_params:
        ...
        print(f"Total Trades: {best_metrics['total_trades']}")  # 新增
...
def compare_strategies_on_prediction_period(
    ...
    print(f"Total trades: {original_metrics['total_trades']}")  # 新增
    ...
    print(f"Total trades: {enhanced_metrics['total_trades']}")  # 新增
    ...
    comparison_df = pd.DataFrame([
        {
            ...
            "total_trades": original_metrics["total_trades"]  # 新增
        },
        {
...
if __name__ == "__main__":
    ...
    parser.add_argument("--minute-data-path", default="I_5.csv")
    ...
    parser.add_argument("--minute-pred-path", default="pred_minute_advanced.csv")#pred_minute_advanced.csv()
...
Fixed Parameters from Training: f1=0.80, f2=0.30, f3=0.20
=======================================================
...
[Original R-Breaker]
Annualized return rate: 14.57%
Total return rate: 8.96%
Sharpe ratio: 0.79
Calmar ratio: 1.16
Win rate: 53.85%
...
[Prediction-Enhanced R-Breaker]
Annualized return rate: 24.14%
Total return rate: 14.62%
Sharpe ratio: 1.08
Calmar ratio: 1.52
Win rate: 53.85%
...
[Prediction-Enhanced R-Breaker]
Annualized return rate: 18.10%
Total return rate: 11.06%
Sharpe ratio: 0.84
Calmar ratio: 1.12
Win rate: 53.85%
