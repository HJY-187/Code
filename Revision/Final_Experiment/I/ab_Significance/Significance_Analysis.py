...
CONFIG = {
    "file_paths": {
        ...
        "true": os.path.join(base_dir, r"I_true.csv")
    },
...
================================================================================
BASELINE vs BASE: GW=22.1865, p=2.3185e-109, Lags=13 -> Significant
MODEL_A vs BASE: GW=2.5781, p=4.9676e-03, Lags=13 -> Significant
MODEL_B vs BASE: GW=30.6057, p=5.1417e-206, Lags=13 -> Significant
...
--- Step 1 ---
  ...
  model_A: p=2.0675e-16 (Lag=13)
  model_B: p=0.0000e+00 (Lag=13)
--- Step 2 ---
  baseline: p=1.2789e-176 (Lag=13)
  model_A: p=1.1416e-09 (Lag=13)
  model_B: p=3.3459e-243 (Lag=13)
--- Step 3 ---
  baseline: p=1.6867e-121 (Lag=13)
  model_A: p=9.3377e-04 (Lag=13)
  model_B: p=3.9116e-122 (Lag=13)
--- Step 4 ---
  baseline: p=3.1123e-136 (Lag=13)
  model_A: p=1.0299e-03 (Lag=13)
  model_B: p=4.4227e-154 (Lag=13)
--- Step 5 ---
  baseline: p=5.1404e-117 (Lag=13)
  model_A: p=1.4227e-01 (Lag=13)
  model_B: p=1.0944e-187 (Lag=13)
--- Step 6 ---
  baseline: p=1.6518e-63 (Lag=13)
  model_A: p=4.0982e-01 (Lag=13)
  model_B: p=1.3895e-167 (Lag=13)
--- Step 7 ---
  baseline: p=5.5342e-43 (Lag=13)
  model_A: p=9.0311e-01 (Lag=13)
  model_B: p=6.9899e-154 (Lag=13)
--- Step 8 ---
  baseline: p=2.5995e-40 (Lag=13)
  model_A: p=9.5665e-01 (Lag=13)
  model_B: p=1.5237e-138 (Lag=13)
--- Step 9 ---
  baseline: p=2.0259e-69 (Lag=13)
  model_A: p=1.5855e-01 (Lag=13)
  model_B: p=1.1470e-103 (Lag=13)
--- Step 10 ---
  baseline: p=2.8634e-69 (Lag=13)
  model_A: p=2.8867e-02 (Lag=13)
  model_B: p=2.4060e-91 (Lag=13)
--- Step 11 ---
  baseline: p=2.8155e-58 (Lag=13)
  model_A: p=5.0625e-02 (Lag=13)
  model_B: p=1.3950e-74 (Lag=13)
--- Step 12 ---
  baseline: p=8.9467e-59 (Lag=13)
  model_A: p=4.7768e-02 (Lag=13)
  model_B: p=4.9563e-74 (Lag=13)
